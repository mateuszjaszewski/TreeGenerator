...
import static pl.mj.treegen.nodes.Node.NodeType;
...
public class TreePanel extends JPanel implements TreeSelectionListener {
	...
	public TreePanel(JPanel rightPanel, Tree tree) {
		...
		treeIcon = new ImageIcon(Tree.class.getClass().getResource("/icons/tree.png"));
		trunkIcon = new ImageIcon(Tree.class.getClass().getResource("/icons/trunk.png"));
		branchesIcon = new ImageIcon(Tree.class.getClass().getResource("/icons/branches.png"));
		sideBranchesIcon = new ImageIcon(Tree.class.getClass().getResource("/icons/sideBranches.png"));
		rootsIcon = new ImageIcon(Tree.class.getClass().getResource("/icons/roots.png"));
		leavesIcon = new ImageIcon(Tree.class.getClass().getResource("/icons/leaves.png"));
		...
		buttonAdd.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				...
				NodeType type = (Node.NodeType)JOptionPane.showInputDialog(
				                    null,
